...
python scripts/run_eval.py --mode hybrid --provider auto --sample-size 15 --dataset-path datasets/eval_questions.json --store-artifacts --output-path logs/eval_report.json
if errorlevel 1 exit /b 1
